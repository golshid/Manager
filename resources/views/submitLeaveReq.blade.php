            ...
            <div id="page-content-wrapper">
                    ...
                    <div class="container">
                        ...
                        <div class="collapse  navbar-collapse" id="navbarToggleExternalContent">
                            ...
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item ">
                                    <a class="nav-link {{ Request::is('home') ? 'myactive' : '' }}" href="/home">Home
                ...
                <main class="py-4">
                    <div class="p-5 mt-3 wholecard container col-6 justify-content-center text-white"
                        ...
                        <form action="{{route('leavereq.create')}}" method="post">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="InputFrom">From</label>
                                        <input type="text" name="from" class="form-control text-white bg-transparent"
                                            id="InputFrom" value={{Auth::user()->name}} readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for="InputFrom">To</label>
                                        <input type="text" name="to" class="form-control text-white bg-transparent"
                                            id="InputTo" value={{$admin->name}} readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="DateFrom"
                                            class="form-control text-white bg-transparent datepicker" id="startDate">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="DateTo"
                                            class="form-control text-white bg-transparent datepicker" id="endDate">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="InputReason">Reason</label>
                                <select id="InputReason" name="reason" class="form-control text-white bg-transparent" required>
                                    <option value="Vacation/Holiday">Vacation/Holiday</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="comment" class="form-control bg-transparent text-white"
                                    id="InputTextarea" rows="5" required></textarea>
                            </div>
