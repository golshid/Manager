        ...
        <form action="">
            <fieldset disabled>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="to" class="form-control text-white bg-transparent" id="InputTo"
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="DateFrom" class="form-control text-white bg-transparent"
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="DateTo" class="form-control text-white bg-transparent"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="reason" class="form-control text-white bg-transparent" value="{{$r->reason}}"
                        id="InputTitle">
                </div>
                <div class="form-group">
                    <label for="InputTextarea">Your Comment</label>
                    <textarea name="comment" class="form-control text-white bg-transparent" rows="4"
